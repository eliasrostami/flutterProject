...
import 'package:flutter_application_train/main.dart';
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text('Hi, Elias',style: themeData.textTheme.subtitle1,),
            ...
            Padding(
              ...
              child: Text('Explore todays',style: themeData.textTheme.headline4,),
            ),
        ...
        children: [
          ...
          Positioned.fill(
            child: Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(32),
                child: Image.asset('img/Posts/large/${category.imageFileName}',fit: BoxFit.cover,)),
            ),
          ),
          Positioned(
            bottom: 48,
        ...
        Stack(
          children: [
            ...
            Positioned(
              right: 0,
              bottom: 0,
              child: Image.asset('assets/img/icons/${story.iconFileName}',width: 32,height: 32,))
          ],
        ),
        const SizedBox(height: 8,),
        Text(story.name,style: themeData.textTheme.bodyText1,)
      ],
    );
  }
...
class _PostsList extends StatelessWidget{
  final posts = AppDatabase.posts;
   _PostsList({Key? key}):super(key: key);
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              TextButton(
                onPressed: (){}, 
                child:const Text('More',style: TextStyle(color: Color(0xff376AED)),))
            ],
          ),
        ),
        ListView.builder(
